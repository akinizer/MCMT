...
<randomMaps 
  displayNameID="STR_MAP_LAND" 
  imagepath="resources\maps\MapThumb_Land.png" 
  helpTextID="STR_LAND_MAP_SET_DESC" 
  cannotReplace="">
  
  <!-- Land Maps. -->
  <map>acropolis_colossal</map>
  ...
  <map>marsh_colossal</map>
  <map>megalopolis_colossal</map>
  <map>mirage_colossal</map>
  <map>mirkwood_colossal</map>
  <map>mount_olympus_colossal</map>
  <map>muspellheim_colossal</map>
  <map>nile_shallows_colossal</map>
  ...
  <!-- Water maps. -->
  <map>anatolia_colossal</map>
  <map>archipelago_colossal</map>
  <map>black_sea_colossal</map>
  <map>highland_colossal</map>
  <map>islands_colossal</map>
